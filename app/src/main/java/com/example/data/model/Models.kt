...
data class UserProfile(
    @PrimaryKey val email: String = "", // Secure account primary key
    ...
    val workoutPreferenceNotes: String = "" // Detailed notes for custom workout preferences & goal visions
)
...
data class WorkoutSession(
    @PrimaryKey(autoGenerate = true) val id: Long = 0,
    val userEmail: String = "", // Tied securely to user email
...
data class HealthTrackerLog(
    @PrimaryKey val id: String, // Constructed as "$dateKey:$userEmail"
